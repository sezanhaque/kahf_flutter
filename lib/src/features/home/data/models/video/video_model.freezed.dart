...
@JsonKey(name: "links") Links get links;@JsonKey(name: "total") int get total;@JsonKey(name: "popular_video_count") int get popularVideoCount;@JsonKey(name: "cache_end_date") DateTime get cacheEndDate;@JsonKey(name: "is_cached_response") bool get isCachedResponse;@JsonKey(name: "page") int get page;@JsonKey(name: "page_size") int get pageSize;@JsonKey(name: "results") List<VideoResultModel> get results;
...
@override
String toString() {
  return 'VideoModel(links: $links, total: $total, popularVideoCount: $popularVideoCount, cacheEndDate: $cacheEndDate, isCachedResponse: $isCachedResponse, page: $page, pageSize: $pageSize, results: $results)';
}
...
@useResult
$Res call({
@JsonKey(name: "links") Links links,@JsonKey(name: "total") int total,@JsonKey(name: "popular_video_count") int popularVideoCount,@JsonKey(name: "cache_end_date") DateTime cacheEndDate,@JsonKey(name: "is_cached_response") bool isCachedResponse,@JsonKey(name: "page") int page,@JsonKey(name: "page_size") int pageSize,@JsonKey(name: "results") List<VideoResultModel> results
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "links")  Links links, @JsonKey(name: "total")  int total, @JsonKey(name: "popular_video_count")  int popularVideoCount, @JsonKey(name: "cache_end_date")  DateTime cacheEndDate, @JsonKey(name: "is_cached_response")  bool isCachedResponse, @JsonKey(name: "page")  int page, @JsonKey(name: "page_size")  int pageSize, @JsonKey(name: "results")  List<VideoResultModel> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VideoModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "links")  Links links, @JsonKey(name: "total")  int total, @JsonKey(name: "popular_video_count")  int popularVideoCount, @JsonKey(name: "cache_end_date")  DateTime cacheEndDate, @JsonKey(name: "is_cached_response")  bool isCachedResponse, @JsonKey(name: "page")  int page, @JsonKey(name: "page_size")  int pageSize, @JsonKey(name: "results")  List<VideoResultModel> results)  $default,) {final _that = this;
switch (_that) {
case _VideoModel():
return $default(_that.links,_that.total,_that.popularVideoCount,_that.cacheEndDate,_that.isCachedResponse,_that.page,_that.pageSize,_that.results);case _:
  throw StateError('Unexpected subclass');
...
class _VideoModel implements VideoModel {
  const _VideoModel({@JsonKey(name: "links") required this.links, @JsonKey(name: "total") required this.total, @JsonKey(name: "popular_video_count") required this.popularVideoCount, @JsonKey(name: "cache_end_date") required this.cacheEndDate, @JsonKey(name: "is_cached_response") required this.isCachedResponse, @JsonKey(name: "page") required this.page, @JsonKey(name: "page_size") required this.pageSize, @JsonKey(name: "results") required final  List<VideoResultModel> results}): _results = results;
...
@override@JsonKey(name: "page_size") final  int pageSize;
 final  List<VideoResultModel> _results;
@override@JsonKey(name: "results") List<VideoResultModel> get results {
