...
abstract class VideoModel with _$VideoModel {
  const factory VideoModel({
    ...
    @JsonKey(name: "channel_username") String? channelUsername,
...
extension EntityMapper on VideoModel {
  VideoEntity toEntity() {
    return VideoEntity(
      ...
      publishedAt: createdAt ?? dateAndTime ?? DateTime.now(),
      duration: duration != null ? duration!.toDuration() : Duration.zero,
